    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(medSpinner.getSelectedItem().toString().equals("Select Medicine")) {
                ...
                {
                    currentMed = medSpinner.getSelectedItem().toString();
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if(task.isSuccessful())
                            {
                                for(DocumentChange doc : task.getResult().getDocumentChanges())
                                {
                                    ...
                                    mFirestore.collection("Medicines").document(doc.getDocument().getId()+"").delete()
                            ...
                            mFirestore.collection("DiseaseMed").whereEqualTo("Medicine",currentMed)
                                    .get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                @Override
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    if(task.isSuccessful())
